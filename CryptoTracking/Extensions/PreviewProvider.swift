...
class DeveloperPreview {
    ...
    let stat1 = StatisticCoin(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
    let stat2 = StatisticCoin(title: "Total Volumn", value: "$1.23Tr")
    let stat3 = StatisticCoin(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
